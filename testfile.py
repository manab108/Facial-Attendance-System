...
class Student:
    ...
    def __init__(self, root):
       ...
       #student ID
        ...
        update_btn=Button(btn_frame,text="Update",width=15,height=1,font=("times new roman",13,"bold"),bg="lightgreen",fg="grey")
        update_btn.grid(row=0,column=1,pady=5,padx=6)

        delete_btn=Button(btn_frame,text="Save",width=15,height=1,font=("times new roman",13,"bold"),bg="lightgreen",fg="grey") 
        delete_btn.grid(row=0,column=2,pady=5,padx=6)

        reset_btn=Button(btn_frame,text="Reset",width=15,height=1,font=("times new roman",13,"bold"),bg="lightgreen",fg="grey") 
        ...
        take_photo_btn=Button(btn2_frame,text="Take Photo Sample",width=32,height=1,font=("times new roman",13,"bold"),bg="lightgreen",fg="grey") 
        ...
        self.student_table=ttk.Treeview(table_frame,columns=("dep","course","year","sem","Id","name","sec","dob","roll","gender","phone","email","address","subjectcode","photo"),xscrollcommand=scrollbar_x.set,yscrollcommand=scrollbar_y.set)
        ...
        self.student_table.heading("Id",text="Scholar Id")
